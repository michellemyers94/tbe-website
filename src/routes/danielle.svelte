...
<h4 use:reveal={{ delay: 50 }}>Danielle Kuntz</h4>
    ...
    <div class="about-us-grid">
        <img src={danielle_portrait} alt="the blank experiment group photo. They are standing in front of a white wall and smiling at eachother while holding their instruments" class="individual-photo" />
