...
<div class="nav-bar-mobile">
    ...
    <aside class:active>
        <ul>
            <li><a href="." on:click={()=> active = !active}>home</a></li>
            <li><a href="/about" on:click={()=> active = !active}>about</a></li>
            ...
            <li><a href="/moon-dances" on:click={()=> active = !active}>Moon Dances</a></li>
        </ul>
    </aside>
</div>
